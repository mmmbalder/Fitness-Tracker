...
function Activity(id, obj) {
  ...
  if (id && obj.date && obj.activity && obj.scalar) {
    activity = {
      id: id,
      date: obj.date,
  ...
  } else if (id && obj.date && obj.activity) {
    activity = {
      id: id,
      date: obj.date,
      activity: obj.activity,
...
function ActivityToList(activity) {
  ...
  return [activity.id, activity.activity, activity.date, activity.scalar]
}